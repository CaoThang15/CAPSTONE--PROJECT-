        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdRefer = table.Column<int>(type: "int", nullable: true),
                    TimeToSend = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vouchers_VoucherStatuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "VoucherStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Vouchers_VoucherStatuses_StatusId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PersonalNotifications_SystemNotifications_SystemNotificationId",
                        column: x => x.SystemNotificationId,
                        principalTable: "SystemNotifications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PersonalNotifications_Users_ToUserId",
                        column: x => x.ToUserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAdminHide = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SharedFiles_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SharedFileId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_SharedFileId",
                table: "Feedbacks",
                column: "SharedFileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonalNotifications_SystemNotificationId",
                table: "PersonalNotifications",
                column: "SystemNotificationId");

            migrationBuilder.CreateIndex(
                name: "IX_PersonalNotifications_ToUserId",
                table: "PersonalNotifications",
                column: "ToUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vouchers_StatusId",
                table: "Vouchers",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_Vouchers_StatusId1",
                table: "Vouchers",
                column: "StatusId1");
        }
